...
function App() {
  ...
  const getIsFormValid = () => {
    ...
    return firstName!=="" && validateEmail(email) && password.length>=8 && (role==="individual" || role ==="business")
      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          ...
          <div className="Field">
            ...
            <input placeholder="Password" type="password" value={password.value}  onChange={handlePasswordChange} />
